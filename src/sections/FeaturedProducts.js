...
import ItemFeaturedTemplate from './ItemFeaturedTemplate';
                ...
                <div className="ps-section__content pb-50">
                    <div className="masonry-wrapper" data-col-md="4" data-col-sm="2" data-col-xs="1" data-gap="30" data-radio="100%">
                        <div className="ps-masonry">
                            ...
                            <ItemFeaturedTemplate categorySlug="nike" />
                            <ItemFeaturedTemplate categorySlug="adidas" />
                            <ItemFeaturedTemplate categorySlug="kids" />
                            <ItemFeaturedTemplate categorySlug="kids" />
                            <ItemFeaturedTemplate categorySlug="kids" />
                            <ItemFeaturedTemplate categorySlug="men" />
                            <ItemFeaturedTemplate categorySlug="women" />
